...
{
	typedef float (*Time_get_fixedTime_m908791845_ftn) ();
	static Time_get_fixedTime_m908791845_ftn _il2cpp_icall_func;
	if (!_il2cpp_icall_func)
	_il2cpp_icall_func = (Time_get_fixedTime_m908791845_ftn)il2cpp_codegen_resolve_icall ("UnityEngine.Time::get_fixedTime()");
	float retVal = _il2cpp_icall_func();
	return retVal;
}
...
extern "C" IL2CPP_METHOD_ATTR void Transform_set_localEulerAngles_m4202601546 (Transform_t3600365921 * __this, Vector3_t3722313464  ___value0, const RuntimeMethod* method)
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{

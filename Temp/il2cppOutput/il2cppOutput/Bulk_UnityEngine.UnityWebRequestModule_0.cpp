...
extern const uint32_t UnityWebRequest_UnEscapeURL_m3013608966_MetadataUsageId;
...
extern "C" IL2CPP_METHOD_ATTR String_t* UnityWebRequest_UnEscapeURL_m3013608966 (RuntimeObject * __this /* static, unused */, String_t* ___s0, Encoding_t1523322056 * ___e1, const RuntimeMethod* method)
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
		il2cpp_codegen_initialize_method (UnityWebRequest_UnEscapeURL_m3013608966_MetadataUsageId);
		s_Il2CppMethodInitialized = true;
	}
	String_t* V_0 = NULL;
...
IL_0031:
	{
		...
		String_t* L_7 = ___s0;
		NullCheck(L_6);
		ByteU5BU5D_t4116647657* L_8 = VirtFuncInvoker1< ByteU5BU5D_t4116647657*, String_t* >::Invoke(10 /* System.Byte[] System.Text.Encoding::GetBytes(System.String) */, L_6, L_7);
		V_1 = L_8;
		ByteU5BU5D_t4116647657* L_9 = V_1;
		IL2CPP_RUNTIME_CLASS_INIT(WWWTranscoder_t272523958_il2cpp_TypeInfo_var);
		ByteU5BU5D_t4116647657* L_10 = WWWTranscoder_URLDecode_m3587034544(NULL /*static, unused*/, L_9, /*hidden argument*/NULL);
		V_2 = L_10;
		Encoding_t1523322056 * L_11 = ___e1;
		ByteU5BU5D_t4116647657* L_12 = V_2;
		NullCheck(L_11);
		String_t* L_13 = VirtFuncInvoker1< String_t*, ByteU5BU5D_t4116647657* >::Invoke(22 /* System.String System.Text.Encoding::GetString(System.Byte[]) */, L_11, L_12);
		V_0 = L_13;
		goto IL_0051;
	}
